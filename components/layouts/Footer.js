       ...
       <div className='mx-auto max-w-6xl px-4'>
         <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 py-6 px-4 space-x-10'>
           ...
           <div className='mt-14 lg:mx-auto'>
             ...
             <ul className='mt-3 flex flex-col gap-1'>
              ...
              <li><Link className='text-white hover:text-white/85 hover:underline' href={"/visa-and-residence-permit"}>Visa &amp; Residence Permit</Link></li>
             </ul>
           </div>
            <div className='mt-14 lg:mx-auto'>
             <h4 className='text-secondary text-base lg:text-lg font-semibold uppercase'>Contact Us</h4>
             <ul className='mt-3 flex flex-col gap-1'>
              <li><IoLocationOutline className='size-7 inline-block text-white'/>&nbsp;<Link className='text-white' href={"/"}>Study in Lithuania Center</Link></li>
        ...
        <div className='pt-4 border-white/75 border-t-2 relative'>
           ...
           <ul className='md:absolute right-2 bottom-0 flex gap-2 justify-end mt-2'>
            <li className='bg-tertiary hover:bg-tertiary/85 w-8 h-8 rounded-full flex justify-center items-center'><Link href={"https://www.youtube.com/IEESIndoEuropean"} target='_blank'><FiYoutube className='size-5 text-white'/></Link></li>
            <li className='bg-tertiary hover:bg-tertiary/85 w-8 h-8 rounded-full flex justify-center items-center'><Link href={"https://www.instagram.com/indo_european"} target='_blank'><FaInstagram className='size-5 text-white'/></Link></li>
            <li className='bg-tertiary hover:bg-tertiary/85 w-8 h-8 rounded-full flex justify-center items-center'><Link href={"https://www.facebook.com/Indoeuropean.in"} target='_blank'><FaFacebook className='size-5 text-white'/></Link></li>
           </ul>
         </div>
       </div>
    </footer>
