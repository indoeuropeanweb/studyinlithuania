       ...
       <div className='container mx-auto'>
         <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 py-6 px-4 space-x-10'>
           ...
           <div className='mt-14 lg:mx-auto'>
             <h4 className='text-secondary font-medium uppercase'>Helpful Links</h4>
             <ul className='mt-3 flex flex-col gap-1'>
              ...
              <li><Link className='text-white hover:text-white/85 hover:underline' href={"/contact"}>Contact Us</Link></li>
               ...
               <div className='mt-14 lg:mx-auto'>
             <h4 className='text-secondary font-medium uppercase'>Resources</h4>
             <ul className='mt-3 flex flex-col gap-1'>
            ...
            <div className='mt-14 lg:mx-auto'>
             <h4 className='text-secondary font-medium uppercase'>Contact Us</h4>
             <ul className='mt-3 flex flex-col gap-1'>
        ...
        <div className='pt-4 border-white/75 border-t-2 relative'>
           ...
           <ul className='md:absolute right-2 bottom-0 flex gap-2 justify-end mt-2'>
            <li className='bg-secondary hover:bg-secondary/85 w-8 h-8 rounded-full flex justify-center items-center'><Link href={"https://youtube.com"}><FiYoutube className='size-5 text-white'/></Link></li>
            <li className='bg-secondary hover:bg-secondary/85 w-8 h-8 rounded-full flex justify-center items-center'><Link href={"https://instagram.com"}><FaInstagram className='size-5 text-white'/></Link></li>
            <li className='bg-secondary hover:bg-secondary/85 w-8 h-8 rounded-full flex justify-center items-center'><Link href={"https://facebook.com"}><FaFacebook className='size-5 text-white'/></Link></li>
           </ul>
         </div>
       </div>
    </footer>
